        ...
        <ul>
          ...
          <li className={css.itemAdressAboutUs}>
            <p className={css.textAboutUs}>
              В сучасному будівництві, будівлі з металоконструкцій мають велику
              перевагу над монолітним або цегляним будівництвом. Велику роль
              відіграє сам каркас металоконструкції (легкий та
              швидкомонтований). Це є будівлі різного призначення та складності.
              Технологія будівництва є незамінною для сучасних магазинів,
              маркетів, автомийок, СТО, ангарів, складів, автосалонів, приміщень
              для проведення масових заходів та будинків з металоконструкцій.
            </p>
          </li>
          <li className={css.itemAdressAboutUs}>
            <p className={css.textAboutUs}>
              Компанія «ОА Андезян» також виконує роботи з монтування: кіосків,
              торгових рядів, павільйонів, вольєрів, дачних будинків, альтанок,
              навісів, парканів та воріт. Також компанія «ОА Андезян» займається
              бетонуванням та улаштуванням покриттів з асфальтобетону.
            </p>
          </li>
          <li className={css.itemAdressAboutUs}>
            <p className={css.textAboutUs}>
              За 15 років успішної роботи компанією «ОА Андезян» було побудовано
              безліч будівель різноманітного типу та призначення. Всі вони
              зведені та побудовані з сучасних матеріалів, дотриманням новітніх
              технологій і відповідають усім сучасним нормам та стандартам ДСТУ.
            </p>
          </li>
        </ul>
      </section>
